...
|--------------------|-----------------------------------------------|--------------------------|
| https://github.com/ManuelBertels/Account-balance | Verwaltet Ein&Ausgaben in Zusammenhang mit CRUD Operationen zum erstellen einer dynamischen Webanwendung     | Next.js, React, CSS      |
